...
class ERCalculator():
    ...
    def calOpModeInfo(
        ...
        brakeCol='braking',
        accCol='acc[m/s2]',
        accBins = np.arange(-4.5, 0.1, 0.1)
    ):
        """
        Calculate OpMode aggregation information.
        """
        OpModesInfo = OpModeAgg(data, OpModeCol=OpModeCol, brakeCol=brakeCol, accCol=accCol, accBins=accBins)
        return OpModesInfo
